  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      ...
      <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href=""><span class="glyphicon glyphicon-log-in"></span> Login</a>
        ...
        <li><a href="#" data-toggle="modal" data-target="#myModal">Representative</a></li>
          <li><a href="loginits.php">Info Tech services</a></li>
          <li><a href="loginworks.php">Dept Of Works</a></li>
          <li><a href="loginstd.php">Staff & Students</a></li>
          <li role="separator" class="divider"></li>
          <li><a href="adminloginpage.php">Administrator</a></li>
        </ul>
      </li>
        <!--=============================-->
...
if (isset($_POST['loginbtn'])) {
    if (isset($_POST['logid']) && isset($_POST['logpwd'])) {
      $getid = mysql_real_escape_string($_POST['logid']);
      $getpass = mysql_real_escape_string($_POST['logpwd']);
...
<br>
  <center><span class="fa fa-envelope" id="anicon"></span></center><br>
  <center><h1>Complaint management system</h1><br>
  <p>Complaint management sytem lets you lay complaint on technical issues that needs immediate response to on campus.</p>
  </center>
</div>
...
<br><br>
  <div class="row">
    ...
    <center>
      ...
      <h3>Having a problem that needs technical response?</h3><br>
    </center>
    </div>
    <div class="col-md-4">
    <center>
      <span class="fa fa-desktop" id="anicon"></span>
      <h3>Log in - lodge complaint - send message!</h3><br>
    </center>
    </div>
    <div class="col-md-4">
    <center>
      <span class="fa fa-cogs" id="anicon"></span>
<h3>Problems will be considered swiftly!</h3><br>    </center>
    </div>
</div>
