...
<body>
  <!--=========================================================rep form cdn=============================================================-->
  <div class="container" >
<h2>New District</h2><hr>
<?php
if(isset($_POST['go'])){
  if(isset($_POST['add_field'])){
  $add_data = mysql_real_escape_string($_POST['add_field']);
  $query = "INSERT INTO `district` VALUES ('','$add_data')";
...
<div class="row">
  ...
  <label for="Addresstoname">District Name:</label>
    <input type="text" name="add_field" class="form-control" placeholder="Enter new district's name" id="Addresstoname" autocomplete="off" required="">
  </div>
  </div>
  <div class="col-md-4">
...
?>
   <div class="row" id="dprow">
      ...
      <div class="col-md-2"><a href="admintools/add_district.php?this=<?php echo $id;?>"<h4><span class= "fa fa-trash" id="actbtn"></span></h4></a></div>
  </div>
<?php } ?>
  </div>
  <div class="col-md-4"></div>
...
if (isset($_GET['this'])) {
    $del_id = $_GET['this'];
          $delete_query = "DELETE FROM `district` WHERE id = '$del_id'";
       if (mysqli_query($connect,$delete_query)){
        header('location: ../adminpage.php?add_district');
                    $by= 'Administrator';
                    $event = 'Removed District '.$del_id;
                    $time = date('D M Y - H:i');
